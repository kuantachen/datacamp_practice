...
# To run a full DAG
airflow trigger_dagt -e <date> <dag_id

# =====================================================

# # Operators Reminder
# 1. BashOperator - expects a bash_command
# 2. PythonOperator - expects a python_callable
# 3. BranchPythonOperator - requires a python_callable and provide_context=True. The callable must be accept **kwargs
# 4. FileSensor - requires filepath argument and might need mode or poke_interval attributes
...
# 3. At prompt, run help(<Aiflow object>), ie. help(BashOperator)
