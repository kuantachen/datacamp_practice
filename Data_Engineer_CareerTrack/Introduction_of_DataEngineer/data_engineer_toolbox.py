...
# DAGs = Directed Acyclic Grapth
# Set of nodes, Directed edges, No cycles

# The tools for the job: Linux's cron, Spotify's Luigi, Apache Airflow
...
## Data in databases
# OLTP: Online Transaction Processing (Application database, row-oriented)
# OLAP: Online Analytical Processing (Analytical database, column-oriented)
...
# The structure of a connection URI for sqlalchemy:
# postgresql://[user[:password]@][host][:port][/database]
